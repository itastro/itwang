...
public final class RecipeTest {
    ...
    public final void canSerializeToJson() throws JsonProcessingException, JSONException {
        ...
        final List<Recipe> recipes = newArrayList(new Recipe.RecipeItemBuilder().withName(NAME).withIngredient(bread)
            .withIngredient(getIngredient("cheese", 2, slices)).build(), new Recipe.RecipeItemBuilder()
